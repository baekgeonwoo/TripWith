package com.janggoback.tripwith.auth.jwt.filter;

import com.janggoback.tripwith.auth.jwt.service.JwtService;
import com.janggoback.tripwith.auth.jwt.util.PasswordUtil;
...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
    ...
    private static final String NO_CHECK_URL = "/api/login"; // "/register"으로 들어오는 요청은 Filter 작동 X
    ...
    public void checkAccessTokenAndAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        log.info("checkAccessTokenAndAuthentication() 호출종료");
